...
const examples = {
    isInteger: (data) => typesHelper({types: "integer", data}, true),
    isArray: (data) => typesHelper({types: "array", data}, true),
    isBuffer: (data) => typesHelper({types: "buffer", data}, true),
    isInt8: (data) => typesHelper({types: "int8", data}, true),
    isUInt8: (data) => typesHelper({types: "uint8", data}, true),
    isInt16: (data) => typesHelper({types: "int16", data}, true),
    isUInt16: (data) => typesHelper({types: "uint16", data}, true),
    isInt32: (data) => typesHelper({types: "int32", data}, true),
    isUInt32: (data) => typesHelper({types: "uint32", data}, true),
};
//
console.log("'only Boolean' use cases:");
console.log("\n============\n");
